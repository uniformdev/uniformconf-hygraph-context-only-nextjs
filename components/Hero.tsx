...
import { Hero as HeroProps } from '../graphql-types';


export function Hero({ title, description, buttonText, image, buttonLinkSlug }: HeroProps) {
  return (
    <>
      <div className="pt-24">
          ...
          <div className="w-full md:w-3/5 py-6 text-center">
            {image && (
              <img
                ...
                height={500}
                src={image.url}
                alt={buttonText ?? 'Alt text is required!'}
              />
            )}
          </div>
        </div>
